    ...
    <div>
      <div className="flex justify-center items-center min-h-screen">
        <article className="prose text-center text-2xl max-w-full px-4bn bn ">
          ...
          <h2>Travel.Me</h2>
          <Link
            href="https://travel--me.vercel.app/ "
            class="no-underline btn btn-primary my-4 target"
            target="_blank"
          >
            View the project
          </Link>
          ...
          <div className=" text-left mx-10">
            <h3 className="text-center mb-10 ">Tech Stack</h3>
            <div className="flex justify-center ">
              <div className="grid grid-cols-3 w-96 gap-10 gap-x-8">
            ...
            <p>
              ...
              <div class="text-center flex md:justify-center">
                <div className="mockup-window border bg-base-300 w-full h-46 justify-center">
                  <div className="flex justify-center  bg-base-200">
                    <img src="/travelme mockup2.png" class="md:w-full" />
                  </div>
                </div>
              </div>
              <blockquote>
              ...
              <div class="text-center flex md:justify-center">
                <div className="mockup-window border bg-base-300 w-full h-46  justify-center">
                  <div className="flex justify-center  bg-base-200">
                    <img src="/travelme mockup3.png" class="md:w-full" />
                  </div>
                </div>
              </div>
              <br></br>
              ...
              <div class="text-center flex md:justify-center">
                <div className="mockup-window border bg-base-300 w-full h-46  justify-center">
                  <div className="flex justify-center  bg-base-200">
                    <img src="/travelme mockup5.png" class="md:w-full" />
                  </div>
                </div>
              </div>
              <blockquote>
                The location and seasonal preference is chosen based on the best
                times to complete the activity, such as seeing the northern
                lights in the winter or hiking in the summer.
              </blockquote>
            </p>
          </div>
        </article>
